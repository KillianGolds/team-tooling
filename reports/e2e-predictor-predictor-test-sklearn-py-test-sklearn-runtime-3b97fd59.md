...
**Confirmed:** 3 · **Suspected:** 3
**First seen:** 2026-06-27T01:43:05+00:00 · **Last seen:** 2026-08-23T11:36:37+00:00
...
- **FAIL** 2026-06-27T01:43:05+00:00 · build `2070670134548107264` · branch `master` · base `b1a9e1942245` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1671/pull-ci-opendatahub-io-kserve-master-e2e-predictor/2070670134548107264)
  - `assert 1 == 2`
- **PASS** 2026-06-26T21:52:41+00:00 · build `2070609724377665536` · branch `master` · base `171919f9ea1b` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1671/pull-ci-opendatahub-io-kserve-master-e2e-predictor/2070609724377665536)

### suspected (base_moved) at `55f8e9ae881c`
- **FAIL** 2026-06-30T15:36:10+00:00 · build `2071953501990162432` · branch `master` · base `7431f5f35afb` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1682/pull-ci-opendatahub-io-kserve-master-e2e-predictor/2071953501990162432)
  - `assert 1 == 2`
- **PASS** 2026-06-30T04:19:22+00:00 · build `2071791224896884736` · branch `master` · base `82c255b05e92` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1682/pull-ci-opendatahub-io-kserve-master-e2e-predictor/2071791224896884736)
...
- **FAIL** 2026-07-17T16:29:34+00:00 · build `2078140063933272064` · branch `master` · base `dfcb3d9587fe` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1737/pull-ci-opendatahub-io-kserve-master-e2e-predictor/2078140063933272064)
  - `assert 1 == 2`
- **PASS** 2026-07-17T18:20:51+00:00 · build `2078169778731618304` · branch `master` · base `dfcb3d9587fe` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1737/pull-ci-opendatahub-io-kserve-master-e2e-predictor/2078169778731618304)
