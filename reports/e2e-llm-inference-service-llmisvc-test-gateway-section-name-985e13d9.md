...
- **FAIL** 2026-07-08T11:59:30+00:00 · build `2074793293689917440` · branch `master` · base `443bbd106f2e` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1702/pull-ci-opendatahub-io-kserve-master-e2e-llm-inference-service/2074793293689917440)
  - `kubernetes.client.exceptions.ApiException: (409)`
- **PASS** 2026-07-07T22:05:34+00:00 · build `2074580936216809472` · branch `master` · base `a016234b9bae` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1702/pull-ci-opendatahub-io-kserve-master-e2e-llm-inference-service/2074580936216809472)
...
- **FAIL** 2026-07-18T09:30:01+00:00 · build `2078380559326777344` · branch `master` · base `afbee690bd11` · [prow](https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/opendatahub-io_kserve/1684/pull-ci-opendatahub-io-kserve-master-e2e-llm-inference-service/2078380559326777344)
  - `AssertionError: Expected at least 1 managed HTTPRoute, got 0`
